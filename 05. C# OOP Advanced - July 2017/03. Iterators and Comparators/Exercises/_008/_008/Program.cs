namespace _008
{
    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            {
                List<string> commandTokens = Console.ReadLine().Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries).ToList();
                ...
                switch (commandType)
                {
                    ...
                    case "Release":
                        ...
                        break;
                    case "HasEmptyRooms":
                        ChechForEmptyRooms(commandTokens[0]);
                        break;
                    case "Print":
        ...
        private static void ChechForEmptyRooms(string clinicName)
        {
