...
public class TestClass
{
    ...
    {
        HeroInventory inv = new HeroInventory();
        CommonItem item = new CommonItem("Sword", 1, 2, 3, 4, 5);

        inv.AddCommonItem(item);

        Assert.AreEqual(1, inv.TotalStrengthBonus);
    }
    ...
    public void TestAgilityBonus()
    {
        ...
        Assert.AreEqual(2, inv.TotalAgilityBonus);
    }
    ...
    public void TestIntelligenceBonus()
    {
        ...
        Assert.AreEqual(3, inv.TotalIntelligenceBonus);
    }
    ...
    public void TestIHitPointsBonus()
    {
        ...
        Assert.AreEqual(4, inv.TotalHitPointsBonus);
    }
    ...
    public void TestDamageBonus()
    {
        ...
        Assert.AreEqual(5, inv.TotalDamageBonus);
    }
}